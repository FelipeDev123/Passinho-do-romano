...
var escolhaForma = document.querySelector('#escolhaForma');
var valores = document.querySelector('#valores');
var btnDiv = document.querySelector('#btnDiv');
var selection = document.querySelector('#escolhaForma');
...
escolhaForma.addEventListener('click', function () {
    if (escolhaForma.value == 'cifra') {
...
btn.addEventListener('click', function (e) {
    ...
    var selection = document.querySelector('#escolhaForma').value;
